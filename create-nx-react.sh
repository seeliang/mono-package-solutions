create-react () {
    ...
    nx g @nx/esbuild:configuration $packages --platform=browser 
     node updatePackageJson.js --update=main:dist/index.js --update=version:1.0.0 --pathToJson=$dir/package.json --update=scripts:build:"nx build" --update=scripts:test:"echo \" no test specified\" && exit 0" 
}
